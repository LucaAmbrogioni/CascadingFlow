...
from modules.models import MeanField, MultivariateNormal, GlobalFlow
from modules.networks import TriResNet, ASVIupdate
...
def rum_timeseries_experiment(exp_name, num_repetitions, num_iterations, batch_size, transition_model,
    ...
    for rep in range(num_repetitions):
        ...
        while True:
            ...
            if (math.isnan(uni_lk) | math.isnan(multi_lk) | math.isnan(pred)):
